...
describe("resolveModel", () => {
  ...
  it("uses codex fallback for gpt-5.4-codex even when openai-codex provider is configured", () => {
    const cfg: OpenClawConfig = {
      models: {
        providers: {
          "openai-codex": {
  ...
  it("reuses configured gpt-5.4 metadata for legacy gpt-5.4-codex refs", () => {
    const cfg: OpenClawConfig = {
      models: {
        providers: {
          "openai-codex": {
